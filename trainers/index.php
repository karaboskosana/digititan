...
<html>
<head>
	<title>Digititan Trainers Forum</title>
		...
		<div id="info">
			<div class="insider">
				<div class="info-insider-left">
					<span class="insider-left-strong" id="info-strong">Welcome to Digital Skills Trainers Forum</span>
		...
		<div id="about">
			<div class="insider">
				...
				<div class="about-container-items">
					<div class="about-par">The Digital Skills Trainers’ Forum is a digital platform where Google’s Digital Skills trainers engage on all matters related to the digital skills training.  This is where trainers share knowledge and experiences among themselves.</div>
				</div>
			</div>
		</div>
	</div>
